...
export default {
    ...
    setup(){
      ...
      const chartData = reactive({
            labels: ["Proyecto Ambiental", "Proyecto Juridico", "Proyecto Tipo..", "Proyecto Tipo 4"] as String[],
            datasets: [
                {
                    label: 'Realizadas 💻',
                    data: [1,4,6,4] as Number[],
...
<template>
    <div class="">
        <div class="card p-3">
            <h6 class="fs-6 mb-0 fw-bolder">Cantidad de Proyectos por tipologia. 📈</h6>
